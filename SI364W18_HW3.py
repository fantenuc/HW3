...
## Worked with: Alex Shell, Sal DiGioia
...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/fantenucHW3"
## Provided:
...
class Tweet(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey('User.user_id')) # name of table
...
class User(db.Model):
    ...
    tweets = db.relationship('Tweet', backref='User') # Tweet is class name, User is class name
